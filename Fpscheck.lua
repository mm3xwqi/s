...
UI.hideBtn.MouseButton1Click:Connect(function()
	...
	smoothToggleBtn(UI.hideBtn,hidePlayersActive,C.WHITE,C.CARD,"DEL PLAYER ON","DEL PLAYER OFF")
end)
UI.enemyBtn.MouseButton1Click:Connect(function()
	...
	smoothToggleBtn(UI.enemyBtn,hideEnemiesActive,C.DANGER,C.CARD,"HIDE ENEMY ON","HIDE ENEMY OFF")
end)
